<template>
  ...
  <div v-else>
    <div class="container">
      ...
      <slot name="addOrUpdate" v-bind:editId="editId"></slot>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async onExportAllConfirm() {
      ...
      const res = await this.model.exportAll()
    ...
    async onSearch() {
      ...
      // })
      // todo: change this
      const res = await this.model.search(this.pageCount, page, this.searchForm)
      this.loading = false
